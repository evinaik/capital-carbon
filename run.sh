...
./Hadoop/bin/hadoop `#This is the mapreduce executable` \
	jar Hadoop/share/hadoop/tools/lib/hadoop-streaming-2.7.2.jar `#Some configurations for the hadoop job` \
	-D mapreduce.job.maps=5 `#Specifies the number of mappers to be  for this job` \
	-D mapreduce.job.reduces=5 `#Specifies the number of reducers to be 2 for this job` \
	-input data.txt `#Specifies the input directory` \
	-output out `#Creates the output directory for the mapreduce job` \
